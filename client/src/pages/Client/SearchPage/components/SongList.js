...
export default function SongList({ searchText }) {
      ...
      <div className="one-music-songs-area mb-70 mt-30">
        <div className="row">
          {songList?.length ? (
            ...
            <div
              style={{ marginLeft: "16px", fontSize: "16px", fontWeight: 600 }}
            >
              Không có bài nhạc phù hợp với kết quả tìm kiếm
            </div>
          )}
