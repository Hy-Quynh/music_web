...
import { getMostFavourite } from "../../../../services/song";
...
export default function MostFavouriteList() {
  ...
  const getMostFavouriteSong = async () => {
    try {
      const hit = await getMostFavourite();
      if (hit?.data?.success) {
